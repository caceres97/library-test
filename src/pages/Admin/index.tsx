...
import Rents from "./Rentals";
import RentDetail from "./RentalDetail";
...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_BASE_URL}/rentals`).then((response) => {
  ...
  const closeRent = (rent: any) => {
    if (rent.isActive) {
      console.log(rent);
      axios
        .patch(
          `${process.env.REACT_APP_BASE_URL}/rentals/${rent.id}/users/${rent.tbl_user.id}/books/${rent.tbl_copy.id}`,
          {}
        )
        .then((response) => {
              ...
              <div className="w-full">
                ...
                <div className="lg:col-span-3">
                  ...
                  <Rents
                    ...
                    setSingleRental={setSingleRental}
                  />
                  <RentDetail
                    isOpen={isOpen}
                    setIsOpen={setIsOpen}
                    singleRent={singleRental}
                    closeRent={closeRent}
                  />
                  {/* /End replace */}
                </div>
