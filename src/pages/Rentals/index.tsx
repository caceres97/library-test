...
import UserRents from "./UserRentals";
...
export default function Rentals() {
  ...
  useEffect(() => {
    ...
    const uid = user.loginResult.id;

    axios.get(`${process.env.REACT_APP_BASE_URL}/users/${uid}/rentals`).then((response) => {
